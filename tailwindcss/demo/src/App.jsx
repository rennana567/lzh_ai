  ...
  return (
    <div className='max-w-xs rounded-lg overflow-hidden bg-white transition-transform duration-300 hover:shadow-xl hover:scale-105 mx-auto'> 
      ...
      <div className='relative'>
        ...
        <button className='absolute top-2 right-2  text-gray-500 transition-colors'>
          {/* 矢量图  数学形状来画图  支持无限放大  不会模糊  区别于像素 */}
      ...
      <div className='p-4'>
        ...
        <div className="flex items-center mt-2">
          ...
          <span className='ml-l text-sm text-gray-500'>4.5(128 reviews)</span>
        </div>
